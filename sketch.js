...
var sad_sound;
var eating_sound;
var star1Img,star1, star2Img, star2;
var blower
var empStar
var oneStar
var twoStar
...
function setup() 
{
  ...
  star2 = createSprite(150,370);
  star2.addImage("ssstarrrr", starImg)
  star2.scale = .02;

  starPoints = createSprite(50,20)
  starPoints.addAnimation("empStar",empStar)
  starPoints.addAnimation("oneStar",oneStar)
  starPoints.addAnimation("twoStar",twoStar)
  starPoints.changeAnimation("empStar")
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)===true){
    star1.visible=false;
    starPoints.changeAnimation("oneStar")
  }
  
  if(collide(fruit,star2,20)===true){
    star2.visible = false;
    starPoints.changeAnimation("twoStar")
    //console.log("HI!")
  }
